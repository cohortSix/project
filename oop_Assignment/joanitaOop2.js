//My first class of bird objects.
...
function bird(type, color, size, origin, featherTexture, footType, beakType){
    ...
    //This is a method in the bird class. It determines how the object behaves.
    this.wingFlap = function(){
        console.log("All birds flap their wings but not all birds can fly");
    }
}

//My first instatiated object called bird1.
var bird1 = new bird("Duck", "Brown", "Small", "Hawaii", "Smooth", "Webbed", "Cone");

//My new object bird2 is instatiated with the keyword new.
var bird2 = new bird("Chicken", "Red", "Small", "France", "Smooth", "nonWebbed", "Pointed");

//I am outputting the beakType value of the newly created object bird1.
console.log(bird1.beakType);
console.log(bird2.type);

//My second class of objects called ball.
...
//The new word is used to instatiate the new object called balla.
...
//My third class of tree objects.
...
//My forth class of fruit objects.
 ...
 //My fifth class of vegetable objects.
 ...
 //My sixth class of book objects.
 ...
 //My seventh class of instrument objects.
 ...
 function instrument(kind, type, name, owner, color, size, materialMake){
     ...
     //This is the method within the instrument class that defines the behaviour of the objects.
     this.sound = function(){
...
//A new object instrument1 is being instatiated with the help of the keyword new. 
